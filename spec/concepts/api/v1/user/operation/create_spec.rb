RSpec.describe Api::V1::User::Operation::Create do
  describe '#call' do
    ...
    context 'when params valid' do
      ...
      it 'creates user' do
        expect { described_class.call(params: user_params, request: test_request) }.to change(User, :count).by(1)
      end
    end

    context 'when params is invalid' do
      it 'retuns contract error' do
        expect(described_class.call(params: {}, request: test_request)['result.contract.default']).to be_failure
      end
    end
  end
end
